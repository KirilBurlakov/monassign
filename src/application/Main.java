...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		//Get the map from the Database and add their names to the listView
	...
	private void drawMap(GraphicsContext gc, ArrayList<City> cities, ArrayList<Road> roads) {
		...
		//Draw the cities and their names by iterating throught the passed ArrayList
		...
		//Draw the roads and their lengths by iterating throught the passed ArrayList
